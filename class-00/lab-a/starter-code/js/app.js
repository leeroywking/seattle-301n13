...
function displayPics(){
  ...
  // because let can be code block scoped and in this case the console.log is outside the code block that let is scoped in. (i didn't notice they were all inside the same function which was really messing me up)
  console.log(viewed);
